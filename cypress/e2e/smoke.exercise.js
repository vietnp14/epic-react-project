...
describe('smoke', () => {
  it('should allow a typical user flow', () => {
    ...
    // Navigate to the finish book page and assert stars are checked
    cy.findByRole('navigation').within(() => {
    ...
    // Remove the book from finish list and check the stars
    ...
    // Reload Finished List for books checking
    cy.findByRole('navigation').within(() => {
      cy.findByRole('link', {name: /finished books/i}).click()
    });
    cy.findByRole('main').within(() => {
